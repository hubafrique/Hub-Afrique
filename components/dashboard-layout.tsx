                          ...
                          {isCollapsed ? (
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Link
                                  href={item.url}
                                  className={`flex items-center justify-center h-9 w-9 sm:h-10 sm:w-10 rounded-lg transition-colors group ${
                                    isActive
                            ...
                            <Link
                              href={item.url}
                              className={`flex items-center space-x-2 sm:space-x-3 px-2 sm:px-3 py-2 rounded-lg transition-colors group ${
                                isActive
                                  ? "bg-orange-100 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400"
                                  : "hover:bg-orange-100 dark:hover:bg-orange-900/20"
                              }`}
