...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-orange-50 via-amber-50 to-red-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-20 lg:py-32 overflow-hidden">
        {/* Background Graphics */}
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* Geometric Shapes */}
          <div className="absolute top-16 right-32 w-20 h-20 bg-gradient-to-r from-orange-400/20 to-red-400/20 rounded-full blur-xl animate-pulse"></div>
          <div
            className="absolute bottom-40 left-32 w-32 h-32 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-full blur-xl animate-pulse"
            style={{ animationDelay: "1.5s" }}
          ></div>
          <div
            className="absolute top-1/2 right-8 w-16 h-16 bg-gradient-to-r from-green-400/20 to-teal-400/20 rounded-full blur-xl animate-pulse"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden lg:block">
              {/* Central Hub */}
              <div className="relative z-20 mx-auto w-80 h-80 flex items-center justify-center">
                ...
                <div className="absolute inset-0 animate-spin" style={{ animationDuration: "20s" }}>
                  ...
                  <div className="absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2">
                    <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-teal-600 rounded-full flex items-center justify-center shadow-lg">
                  ...
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
                    <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-yellow-600 rounded-full flex items-center justify-center shadow-lg">
                ...
                {/* Floating Stats */}
                <div
                  className="absolute -top-8 -left-8 bg-white dark:bg-slate-800 rounded-lg shadow-lg p-3 animate-bounce"
                  style={{ animationDelay: "2s" }}
                >
                  <div className="flex items-center space-x-2">
                    <TrendingUp className="w-4 h-4 text-green-500" />
                    <span className="text-sm font-semibold text-slate-900 dark:text-slate-100">50K+</span>
                  </div>
                  <p className="text-xs text-slate-600 dark:text-slate-400">Professionals</p>
                </div>

                <div
                  className="absolute -bottom-8 -right-8 bg-white dark:bg-slate-800 rounded-lg shadow-lg p-3 animate-bounce"
                  style={{ animationDelay: "3s" }}
                >
                  <div className="flex items-center space-x-2">
                    <Network className="w-4 h-4 text-blue-500" />
                    <span className="text-sm font-semibold text-slate-900 dark:text-slate-100">200+</span>
                  </div>
              ...
              <div className="absolute top-8 right-8 w-6 h-6 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full animate-ping"></div>
              <div
                className="absolute bottom-8 left-8 w-4 h-4 bg-gradient-to-r from-green-400 to-blue-500 rounded-full animate-ping"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute top-1/3 right-4 w-8 h-8 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full animate-ping"
                style={{ animationDelay: "2s" }}
              ></div>
            </div>
