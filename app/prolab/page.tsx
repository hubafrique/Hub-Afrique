      ...
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">ProLab Learning Hub</h1>
              <p className="opacity-90">Master new skills with AI-powered learning</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="border-blue-200 bg-blue-50/50">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-blue-600">Courses Enrolled</p>
              ...
              {filteredCourses.map((course) => (
                <Card key={course.id} className="hover:shadow-lg transition-shadow">
                  <div className="relative">
                    ...
                    />
                    {course.isEnrolled && <Badge className="absolute top-2 right-2 bg-green-500">Enrolled</Badge>}
                    {course.price === "Premium" && (
                      <Badge className="absolute top-2 left-2 bg-orange-500">Premium</Badge>
                    )}
                  </div>
                  <CardHeader>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-slate-600">by {course.instructor}</span>
                      ...
                      <div className="flex gap-2">
                        {course.isEnrolled ? (
                          ...
                          <Button className="flex-1 bg-orange-500 hover:bg-orange-600">Enroll Now</Button>
                        )}
