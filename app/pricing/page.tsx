...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 border-t border-slate-200 dark:border-slate-700">
              <div className="space-y-4">
                ...
                <Link
                  href="/pricing"
                  className="block px-4 py-2 text-slate-700 dark:text-slate-300 hover:text-orange-600 font-medium"
                >
                  Pricing
                </Link>
      ...
      {/* Hero Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-orange-50 via-amber-50 to-red-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 dark:text-slate-100 mb-4 sm:mb-6 leading-tight">
            Invest in Your{" "}
          ...
          <div className="flex items-center justify-center space-x-3 sm:space-x-4 mb-8 sm:mb-12">
            ...
            <Badge className="bg-green-100 text-green-800 border-green-200 ml-2 text-xs sm:text-sm">Save 17%</Badge>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {plans.map((plan, index) => (
              <Card
                ...
                className={`relative ${
                  plan.popular
                    ? "border-orange-200 dark:border-orange-700 shadow-lg md:scale-105"
                    : "border-slate-200 dark:border-slate-700"
                } hover:shadow-xl transition-all duration-300`}
              >
                {plan.popular && (
                  <div className="absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2">
                    <Badge className={plan.badgeColor + " text-xs sm:text-sm"}>{plan.badge}</Badge>
                  </div>
                )}
                ...
                <CardHeader className="text-center pb-6 sm:pb-8 p-4 sm:p-6">
                  ...
                  <CardDescription className="text-slate-600 dark:text-slate-400 mt-2 text-sm sm:text-base">
                    {plan.description}
                  </CardDescription>
                    ...
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-start space-x-2 sm:space-x-3">
                        {feature.included ? (
                          ...
                          <X className="w-4 h-4 sm:w-5 sm:h-5 text-slate-400 mt-0.5 flex-shrink-0" />
                        )}
                        <div>
                          <span
      ...
      <footer className="bg-slate-900 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center text-slate-400">
            <p>&copy; 2025 Hub Afrique. All rights reserved.</p>
