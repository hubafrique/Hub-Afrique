        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              Here's what's happening with your professional journey today.
            </p>
          </div>
            ...
            <Card className="border-orange-200 bg-orange-50 dark:bg-orange-900/20">
              <CardContent className="p-3 sm:p-4 md:p-6">
                <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-orange-700 dark:text-orange-200 mt-1 leading-relaxed">
                      Finish a course in ProLab to earn your certificate and gain access to collaborative projects in
                      iHub.
                    </p>
                  </div>
                  <Button className="bg-orange-600 hover:bg-orange-700 text-white w-full sm:w-auto text-sm">
                    Continue Learning
            ...
            {stats.map((stat, index) => (
              <Card key={index} className="hover:shadow-md transition-shadow">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 p-3 sm:p-4 md:p-6 sm:pb-2">
                  <CardTitle className="text-xs sm:text-sm md:text-base font-medium leading-tight">
                    {stat.title}
                  </CardTitle>
                ...
                <CardContent className="p-3 sm:p-4 md:p-6 pt-0">
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground mt-1">{stat.change}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="lg:col-span-2">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardDescription className="text-xs sm:text-sm">Your current courses and achievements</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 sm:space-y-6 p-4 sm:p-6 pt-0">
                {enrollments.length > 0 ? (
                    ...
                    <div key={enrollment.id} className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-xs sm:text-sm font-medium truncate pr-2">
                          {(enrollment as any).courses?.title || "Course"}
                        </span>
                  ...
                  <div className="text-center py-6 sm:py-8">
                    <BookOpen className="w-10 h-10 sm:w-12 sm:h-12 text-slate-400 mx-auto mb-4" />
                    <p className="text-slate-600 dark:text-slate-400 text-sm">No courses enrolled yet</p>
                    <Button className="mt-4 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-sm">
                      Browse Courses
                    </Button>
                  </div>
                )}
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <Card>
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardDescription className="text-xs sm:text-sm">
                  Your latest notifications and achievements
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-6 pt-0">
                {notifications.length > 0 ? (
                  notifications.map((notification) => (
                    <div key={notification.id} className="flex items-start space-x-3">
                      <div className="flex-shrink-0 mt-0.5">
                        ...
                        {notification.type === "ihub_invite" && (
                          <Users className="w-3 h-3 sm:w-4 sm:h-4 text-green-600" />
                        )}
                        {notification.type === "general" && <Clock className="w-3 h-3 sm:w-4 sm:h-4 text-slate-600" />}
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs sm:text-sm font-medium line-clamp-2">{notification.title}</p>
                  ...
                  <div className="text-center py-4">
                    <p className="text-slate-600 dark:text-slate-400 text-sm">No recent updates</p>
                  </div>
                )}
                <Button variant="outline" className="w-full bg-transparent text-sm">
            ...
            <Card>
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardDescription className="text-xs sm:text-sm">Courses picked based on your interests</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-6 pt-0">
          ...
          <Card>
            <CardHeader className="p-4 sm:p-6">
              ...
              <CardDescription className="text-xs sm:text-sm">Jump into your most common tasks</CardDescription>
            </CardHeader>
            <CardContent className="p-4 sm:p-6 pt-0">
              <div className="grid gap-3 sm:gap-4 grid-cols-2 lg:grid-cols-4">
                <Button className="h-16 sm:h-20 flex-col space-y-1 sm:space-y-2 bg-blue-50 hover:bg-blue-100 text-blue-700 border-blue-200">
                ...
                <Button className="h-16 sm:h-20 flex-col space-y-1 sm:space-y-2 bg-orange-50 hover:bg-orange-100 text-orange-700 border-orange-200">
                  <Briefcase className="h-4 w-4 sm:h-6 sm:w-6" />
                  <span className="text-xs sm:text-sm">Find Jobs</span>
                </Button>
                <Button className="h-16 sm:h-20 flex-col space-y-1 sm:space-y-2 bg-purple-50 hover:bg-purple-100 text-purple-700 border-purple-200">
